...
> постановка — [`.claude/PROMPT.md`](../.claude/PROMPT.md). Раздел 6 — предложение, в плане его пока нет.
...
Для лекции достаточно пунктов 1 и 5: слайд 37 уже рисует `predictions → monitoring`, а в демо этого узла нет.
