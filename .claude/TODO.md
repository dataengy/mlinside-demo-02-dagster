...
- [ ] P12 Non-critical находка codex-ревью PR #22: [#23](https://github.com/dataengy/mlinside-demo-02-dagster/issues/23) `session-backlog-hook.sh` — yq-null обходит дефолты для `tmp_dir`/`preview`, если ключ уберут из settings.yml #agentic
